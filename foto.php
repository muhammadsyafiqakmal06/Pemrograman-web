			...
			<div class="row">
				...
				<div class="col-md-4">
					<table class="table">
						...
						<tr>
							<td colspan="2"><a href="gallery/'.$row['nama'].'" class="btn btn-primary btn-block">View Picture</a></td>
						</tr>
						<tr>
							<td colspan="2"><a href="hapus.php?id='.$id.'" class="btn btn-primary btn-block">Delete</a></td>
						</tr>
					</table>
				</div>
			</div>
